...
BEGIN
    ...
    BEGIN
        ...
        -- Calcular diferencias basándose en el saldo teórico (Apertura + Ventas en Efectivo)
        DECLARE @TeoricoNio DECIMAL(18,2), @TeoricoUsd DECIMAL(18,2);
        SELECT @TeoricoNio = (MONTO_INICIAL_NIO + TOTAL_EFECTIVO_NIO),
               @TeoricoUsd = (MONTO_INICIAL_USD + TOTAL_EFECTIVO_USD)
