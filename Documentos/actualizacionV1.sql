...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'VEN' AND TABLE_NAME = 'VENTA_DETALLE' AND COLUMN_NAME = 'DEVUELTO')
BEGIN
    ALTER TABLE VEN.VENTA_DETALLE ADD DEVUELTO BIT NOT NULL DEFAULT 0;
END

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'VEN' AND TABLE_NAME = 'VENTA_DETALLE' AND COLUMN_NAME = 'ES_REGALIA')
BEGIN
